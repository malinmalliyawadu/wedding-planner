...
function Rings() {
  return (
    <>
      <circle cx="9.4" cy="14.6" r="6.4" />
      <circle cx="15.4" cy="14.6" r="6.4" />
      {/* The stone, set on the near band. */}
      <path d="M 15.4 8.2 L 17.1 5.6 L 18.8 8.2 L 17.1 10.1 Z" />
    </>
  );
}
...
function Glasses() {
  const flute = (
    <>
      ...
      <path d="M 6.7 3.4 L 13.3 3.4 L 11.5 11.6 Q 10 13.7 8.5 11.6 Z" />
      <path d="M 10 13.7 L 10 19.9" />
      <path d="M 7.2 20.4 L 12.8 20.4" />
    </>
  );
  return (
    <>
...
function Cake() {
  return (
    <>
      <path d="M 4.6 18.6 L 4.6 15.2 L 19.4 15.2 L 19.4 18.6 Z" />
      <path d="M 6.6 15.2 L 6.6 11.8 L 17.4 11.8 L 17.4 15.2" />
      <path d="M 8.6 11.8 L 8.6 8.6 L 15.4 8.6 L 15.4 11.8" />
      {/* The stand: a stem and a foot, so it is not a stack of boxes. */}
      <path d="M 12 18.6 L 12 20.4" />
      <path d="M 8.4 21 Q 12 19.4 15.6 21" />
      <path d="M 12 8.6 L 12 6.2" />
      <circle cx="12" cy="5.1" r="0.9" />
    </>
  );
}
    ...
    <>
      <path
        d="M 4.4 8.8 L 8.2 8.8 L 9.6 6.6 L 14.4 6.6 L 15.8 8.8 L 19.6 8.8
           ...
           L 4.4 18.6 Q 3.2 18.6 3.2 17.4 L 3.2 10 Q 3.2 8.8 4.4 8.8 Z" />
      <circle cx="12" cy="13.4" r="3.7" />
      <circle cx="17.8" cy="10.9" r="0.7" />
    </>
  );
}
...
function Gift() {
  return (
    <>
      <path d="M 5.2 11.4 L 5.2 20 L 18.8 20 L 18.8 11.4" />
      <path d="M 3.8 8.2 L 20.2 8.2 L 20.2 11.4 L 3.8 11.4 Z" />
      <path d="M 12 8.2 L 12 20" />
      {/* Two loops meeting where the ribbon does. */}
      <path d="M 12 8.2 C 9.4 8.2 7.6 6.6 8.4 5.2 C 9.1 4 11.2 4.8 12 8.2 Z" />
      <path d="M 12 8.2 C 14.6 8.2 16.4 6.6 15.6 5.2 C 14.9 4 12.8 4.8 12 8.2 Z" />
    </>
  );
}
...
function Clock() {
  return (
    <>
      ...
      <path d="M 12 7.4 L 12 12.6 L 15.6 10.4" />
      {/* The winder, so it is a pocket watch and not a ring. */}
      <path d="M 10.6 3.6 L 13.4 3.6 M 12 3.6 L 12 4.6" />
    </>
  );
}
...
function Key() {
  return (
    <>
      <ellipse cx="7.6" cy="12" rx="3.9" ry="3.9" />
      <path d="M 11.5 12 L 20.6 12" />
      <path d="M 17.2 12 L 17.2 15.2 M 20 12 L 20 14.4" />
    </>
  );
}
...
function Hanger() {
  return (
    <>
      <path d="M 12 8.6 C 9.9 8.6 9.9 5.6 12 5.6 C 13.8 5.6 14.1 7.6 12.4 8.2 L 12 9.4" />
      <path d="M 12 9.4 L 3.6 15.8 Q 2.8 16.6 3.9 17 L 20.1 17 Q 21.2 16.6 20.4 15.8 Z" />
    </>
  );
}
...
function Quill() {
  return (
    <>
      ...
      />
      <path d="M 7.4 15.6 L 4.6 19.6" />
      <path d="M 9.6 12.4 L 13.8 8.4" />
      <path d="M 3.2 20.6 L 11.6 20.6" />
    </>
  );
}
...
function Compass() {
  return (
    <>
      ...
      <path d="M 12 5 L 14 12 L 12 19 L 10 12 Z" />
      <path d="M 5 12 L 12 10 L 19 12 L 12 14 Z" />
    </>
  );
}
...
/**
 * One emblem, drawn into a 24x24 box. Stroked in `currentColor` with no
